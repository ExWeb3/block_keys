  ...
  describe "decode_extended_key/1" do
    test "it returns a map with all decoded bytes given a base58check private encoded extended key" do
      ...
      assert master_private_key == %{
               ...
               index: <<0, 0, 0, 0>>,
               key:
                 <<0, 48, 166, 181, 156, 204, 201, 36, 252, 159, 253, 74, 176, 140, 92, 1, 240,
                   214, 164, 4, 103, 151, 187, 37, 93, 137, 25, 235, 62, 149, 192, 136, 113>>,
    ...
    test "it returns a map with all decoded bytes given a base58check public encoded extended key" do
      ...
      master_public_key =
        CKD.master_public_key(master_private_key)
        |> Encoding.decode_extended_key()
      ...
      assert master_public_key == %{
               ...
               index: <<0, 0, 0, 0>>,
               key:
                 <<3, 128, 40, 86, 6, 23, 133, 88, 180, 217, 74, 146, 146, 5, 72, 251, 163, 93,
                   11, 149, 248, 168, 127, 44, 43, 86, 72, 90, 205, 149, 136, 223, 33>>,
