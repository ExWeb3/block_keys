defmodule MnemonicTest do
  ...
  describe "phrase_from_entropy" do
    test "it generates entropy given a 24 word mnemonic with correct checksum" do
      ...
      entropy = <<190, 22, 251, 240, 146, 43, 249, 9, 140, 75, 252, 161, 118, 73, 35, 209, 14,
        137, 5, 77, 231, 112, 145, 240, 175, 51, 70, 244, 156, 246, 101, 254>>

      phrase = Mnemonic.generate_phrase_from_enthropy(entropy)
