defmodule Bip32MnemonicTest do
  ...
  describe "child_key_public/2" do
    test "it returns the base58 encoded child extended public key given parent extended key and index" do
      ...
      child_extended_public_key = Bip32Mnemonic.child_key_public(master_public_key, 0)
  ...
  describe "child_key_private/2" do
    test "it returns the base58 encoded child extended public key given parent extended key and index" do
      ...
      child_extended_private_key = Bip32Mnemonic.child_key_private(master_private_key, 0)
