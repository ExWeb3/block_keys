defmodule CKDTest do
  ...
  describe "derive/2" do
    test "derives extended private key from parent extended private key" do
      ...
      assert CKD.derive(xprv, path) == "xprv9y3jSNj99vGEj1FGiDETNSpMAf6K1EJkBXTmqASb6RP5BhiaFqPsfVoWKDAPG4kpGVmxannsEpWh3jLeahq9KoFgPHjwjNDcb3GbqcLCbvZ"
    end
    ...
    test "derives xpub from master using BIP44 path" do
      ...
      assert CKD.derive(xprv, path) == "xpub6C35qtG2zHpXwVKjpEmTjam5igvoQh2bYkPNdYrCekv44W3ioNi8DJ7zAXTuWgYCbm57ZZRhgiwC56dCYvzfur7pxwKQhcgqga7fafdeH4q"
    end
  ...
  describe "child_key_public/2" do
    test "it returns the base58 encoded child extended public key given parent extended key and index" do
      ...
      assert child_extended_public_key == "xpub686qTu6J49gBYxxSMhXKe9v7h8eBf7uKdDNVrfa5nBhHS7SNqi4kcCwsX8VvirP3yp8eiw3X8a6v1MAzBNTzeiuhVgTgptPLi4C9whoB5Qg"
    end
  end
  ...
  describe "child_key_private/2" do
    test "it returns the base58 encoded child extended public key given parent extended key and index" do
      ...
      assert child_extended_private_key == "xprv9u7V4PZQDn7tLUsyFfzKH1yP96ohFfBUFzSu4HAUDrAJZK7EJAkW4QdPftAnA6t3SauQvxBmMMbYb8YXYgFuyxEVaQ5tZYD74zkfZu4AuZF"
    end
  end
end
